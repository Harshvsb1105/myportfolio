            ...
            Row(
              children: [
                VStack([
                  ...
                  40.heightBox,
                  nameWidget,
                  if(context.isMobile)20.heightBox else 20.heightBox,
                  VxBox()
  ...
  Widget build(BuildContext context) {
    return [
      Icon(
        ...
        launch("https://www.linkedin.com/in/harshvardhan-bhadouria-b02587160/");
      }).make(),
      20.widthBox,
      Icon(
        AntDesign.github,
      ...
      Icon(
        ...
        launch(
            "https://documentcloud.adobe.com/link/track?uri=urn:aaid:scds:US:076fe837-b1bc-4427-ba9f-1bd90ee3dde3");
      }).make(),
    ].hStack();
  }
}
